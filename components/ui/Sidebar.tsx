                                    ...
                                    <li key={item.name}>
                                        <Link
                                            ...
                                            className={classNames(
                                                isActive
                                                    ? 'bg-white dark:bg-zinc-900 text-brand-primary dark:text-brand-light shadow-sm'
                                        ...
                                        >
                                            <item.icon
                                                className={classNames(
                                                    isActive ? 'text-brand-primary dark:text-brand-light' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300',
                                                    'h-5 w-5 shrink-0'
                                                )}
                                                aria-hidden="true"
                                            />
