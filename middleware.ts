...
export const config = {
    matcher: [
         ...
         * - Static public assets: svg, png, jpg, jpeg, gif, webp, ico, mp3, mp4, woff, woff2
         */
        '/((?!_next/static|_next/image|favicon\\.ico|favicon\\.svg|.*\\.svg$|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.gif$|.*\\.webp$|.*\\.ico$|.*\\.mp3$|.*\\.mp4$|.*\\.woff2?$).*)',
    ],
}
